...
function make_balance_block($currency, $data)
{
    ...
    <div align="center" style="border-style: solid; border-radius: 15px; border-color: aqua; width: 200px;">
        ...
        if ($data->{$currency} != 'null') {
            ...
            echo "<p style=\"text-align: left; padding-left: 20px; color: gray\"> Unconfirmed: " . number_format(floatval($data->{$currency}->balance_unconf), 8)  . " </p></a>";
        } else {
                  ...
                  <div class="u-form u-form-1">
                    <form action="deposit.php?submit=true" method="POST" class="u-clearfix u-form-custom-backend u-form-horizontal u-form-spacing-15 u-inner-form" style="padding: 15px" source="custom" redirect="true" name="idtest">
                      <div class="u-form-group u-form-submit">
                        <a href="#" class="u-btn u-btn-submit u-button-style u-btn-1">Deposit<br>
                        </a>
...
<div id="smart-button-container">
    <div style="text-align: center"><label for="description"> </label><input readonly type="text" name="descriptionInput" id="description" maxlength="127" value="Token Deposit"></div>
    <p id="descriptionError" style="visibility: hidden; color:red; text-align: center;">Please enter a description</p>
    <div style="text-align: center; color: black"><label for="amount">Amount To Deposit </label><input name="amountInput" type="number" id="amount" value="" ><span> USD</span></div>
